...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_HumanLabelling = QtWidgets.QPushButton(self.centralwidget)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/questionnaire.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_HumanLabelling.setIcon(icon2)
        self.pushButton_HumanLabelling.setIconSize(QtCore.QSize(100, 100))
        self.pushButton_HumanLabelling.setObjectName("pushButton_HumanLabelling")
        self.verticalLayout.addWidget(self.pushButton_HumanLabelling)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_HumanLabelling.setText(_translate("MainWindow", "Questionnaire"))
